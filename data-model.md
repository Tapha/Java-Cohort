...
Meals - ID(Primary key), UserID(Foreign Key), Created at, Updated at, Deleted at
Fridge - ID(Primary key),Created at, Updated at, Deleted at
Images -ID(Primary key), FridgeID(Foreign Key),Created at, Updated at, Deleted at
Ingredients-ID(Primary key),Created at, Updated at, Deleted at
Recipies - ID(Primary key), includes time to complete column, Created at, Updated at, Deleted at
